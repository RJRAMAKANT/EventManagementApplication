...
%>
<%ArrayList<Ebooking>all=new NextEventDao().userbooking1(); %>
<%ArrayList<BookingCountBean>all1=new BookingCount().booking2(); %>
...
<%ArrayList<FeedBack>all2=new AllFeedBack().allFeedback1(); %>
  <div class="hero_area">
    ...
    <section class=" slider_section position-relative bg-white pb-2 ">
       <div class="text-center mb-2" style="font-weight:bold;font-family:Arial;font-size:20px;color:black;">UPCOMING EVENTS</div> 
        <div >
        <div>
        ...
        <thead>
           ...
           <% Ebooking pb=(Ebooking)all.get(i); %>
             ...
             <td><%=pb.getAddress()%></td>
             <td><%=pb.getStatus()%></td>
             <td><form action="statusupdatee" method="post">
	...
	<section style="background-color:white;" >
		<div class="d-flex  justify-content-around">
			<div>
				...
				<div class="text-center" style="font-weight: bold; font-family: Arial; font-size: 20px; color:black;">ALL EVENT BOOKING</div>
